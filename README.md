...
- `manage-web`: a [Next.js](https://nextjs.org) app
- `liff`: a [Next.js](https://nextjs.org) app
- `ui`: a stub React component library used by `manage-web` and `liff`.
...
- manage-web 
    - `cd apps/manage-web && cp .env.example .env`
- liff 
    - `cd apps/liff && cp .env.example .env`
- api 
